...
export interface ApiUserActivityUserActivity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activity_details: Schema.Attribute.JSON;
    ...
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    kelp_allocated: Schema.Attribute.Float & Schema.Attribute.DefaultTo<0>;
    kelp_points: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    kelp_trophies: Schema.Attribute.Float & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::user-activity.user-activity'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    is_user_cheating: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    referal_id: Schema.Attribute.String;
    reffered_by: Schema.Attribute.String;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    role: Schema.Attribute.Relation<'manyToOne', 'plugin::users-permissions.role'>;
